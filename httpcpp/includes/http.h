...
#include "mimetypes.h"
#include "commons.h"
#include "../src/asio/httpclientconnection.h" //TODO name without path
...
private:
	...
	std::shared_ptr< std::istream > out_body;
	std::string _method, _protocol;
	std::string _uri, _remote_ip;
	int _http_version_major, _http_version_minor;
	size_t body_size;
};
...
public:
	...
	void invoke ( HttpRequest & request );
